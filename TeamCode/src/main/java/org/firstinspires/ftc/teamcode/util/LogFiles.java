...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double trackingTicksPerRev = StandardTrackingWheelLocalize.TICKS_PER_REV;
        public double trackingWheelRadius = StandardTrackingWheelLocalize.WHEEL_RADIUS;
        public double trackingGearRatio = StandardTrackingWheelLocalize.GEAR_RATIO;
        public double trackingLateralDistance = StandardTrackingWheelLocalize.LATERAL_DISTANCE;
        public double trackingForwardOffset = StandardTrackingWheelLocalize.FORWARD_OFFSET;
